...
@NgModule({
  ...
  // IMPORTANTE: HttpClientModule es necesario para realizar peticiones HTTP.
  imports: [BrowserModule, HttpClientModule, AppRoutingModule, HeaderComponent, FooterComponent],
  providers: [],
